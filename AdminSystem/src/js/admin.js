(function () {
    ...
    if (usn) {
        ...
        $('#menu_list').on('click', 'h2', function () {
            ...
            let len = $(this).next().children().length * 36;
        ...
        let arr = ['html/userinf.html', 'html/reg.html', 'html/goodslist.html', 'html/goodsinf.html', 'html/addgoods.html','html/buyinf.html'];
